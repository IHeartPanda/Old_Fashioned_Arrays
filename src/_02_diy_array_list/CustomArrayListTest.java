...
public class CustomArrayListTest {
	...
	/*
	 * @Test public void testSet() { ArrayList<String> list = new
	 * ArrayList<String>(); list.add("TESTER"); list.add("ONE"); list.add("TWO");
	 * list.add("THREE");
	 * 
	 * list.set(2, "PICKLES");
	 * 
	 * if(!list.get(0).equals("TESTER"))
	 * fail("list.get(0) returning improper value."); if(!list.get(1).equals("ONE"))
	 * fail("list.get(1) returning improper value.");
	 ...
	 * 
	 * @Test public void testAddAt() { ArrayList<Character> list = new
	 * ArrayList<Character>(); list.add('D'); list.add('I'); list.add('G');
	 * list.add('O');
	 * 
	 * list.addAt(2, 'E');
	 * 
	 ...
	 * 
	 * @Test public void testRemove() { class Student { public String name; public
	 * Student(String s) { name = s; } } ArrayList<Student> list = new
	 * ArrayList<Student>(); list.add(new Student("Tim")); list.add(new
	 * Student("Sara")); list.add(new Student("Kamara")); list.add(new
	 * Student("Devaugn"));
	 * 
	 * list.remove(0);
	 * 
	 ...
	 * fail("list.get(2) returning improper value."); }
	 * 
	 * list.remove(2); if(!list.get(0).name.equals("Sara")) {
	 * fail("list.get(0) returning improper value."); }
	 * if(!list.get(1).name.equals("Kamara")) {
	 * fail("list.get(1) returning improper value."); } }
	 * 
